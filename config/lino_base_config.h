...
#define USE_BLDC_IN_MOTOR_DRIVER   // Motor with BLDC Drivers e.g BLD-330B
...
#define COUNTS_PER_REV3 8255              // wheel3 encoder's no of ticks per rev
#define COUNTS_PER_REV4 8255              // wheel4 encoder's no of ticks per rev
